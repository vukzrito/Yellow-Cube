...
using Yellow_Cube.Authorization;
using Yellow_Cube.Helpers;
using System;
using System.Collections.Generic;
using AppPermissions = DAL.Core.ApplicationPermissions;

namespace Yellow_Cube
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Yellow_Cube")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - Yellow_Cube";
            ...
            app.UseSpa(spa =>
            {
                ...
                spa.Options.StartupTimeout = TimeSpan.FromSeconds(360); // Increase the timeout if angular app is taking longer to startup

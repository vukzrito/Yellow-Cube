    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await EnsureRoleAsync(driverRoleName, "Default driver", new string[] { });

                await CreateUserAsync("admin", "tempP@ss123", "Inbuilt Administrator", "admin@ebenmonney.com", "+27 76 000 0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "tempP@ss123", "Inbuilt Standard User", "user@ebenmonney.com", "+27 76 000 0001", new string[] { userRoleName });
                await CreateUserAsync("driver", "tempP@ss123", "Inbuilt Driver", "user@ebenmonney.com", "+27 76 000 0002", new string[] { driverRoleName });

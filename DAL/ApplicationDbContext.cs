...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<VehicleCategory>().ToTable(nameof(VehicleCategories));
            builder.Entity<Vehicle>().ToTable(nameof(Vehicles));
            builder.Entity<Trip>().ToTable(nameof(Trips));
            builder.Entity<Driver>().ToTable(nameof(Drivers));
            builder.Entity<VehicleLocation>().ToTable(nameof(VehicleLocations));
            builder.Entity<Location>().ToTable(nameof(Locations));
        }
